...
const host = '13.140.174.60'; // user's VPS IP
const port = 1812;
...
client.on('message', function(msg, rinfo) {
  ...
  console.log('Received response from RADIUS server:');
...
setTimeout(() => {
    console.log("Timeout waiting for RADIUS response");
    client.close();
}, 5000);
