...
export const Route = createFileRoute("/")({
  head: ({ loaderData }) => {
    ...
    const desc = `Run your ISP business on autopilot: M-Pesa payments, automatic MikroTik Hotspot/PPPoE activation and expiry, and per-business isolation. ${trial}-day free trial. Then KES ${price.toLocaleString()}/mo.`;
...
const features = [
  ...
  },
  {
    ...
    body: "Customers pay to your own Till or PayBill. Payments land in your account, activation happens seconds later.",
  },
  {
    icon: ShieldCheck,
  ...
  {
    icon: Building2,
    title: "Built for Kenyan ISPs",
    body: "KES pricing, Safaricom Daraja, county-level records and the workflows small providers actually use.",
  },
];
        ...
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              Live MikroTik & M-Pesa Nodes Active
            </Badge>
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2 z-20">
            <div className="flex flex-col items-start text-left">
              ...
              <p className="mt-6 text-lg text-muted-foreground sm:text-xl max-w-xl leading-relaxed">
                Connect your MikroTik routers directly to M-Pesa STK Push. Automated provisioning,
                instant receipt validation, and hard tenant isolation engineered for modern ISPs.
              </p>
              ...
              <div className="mt-10 grid grid-cols-3 gap-6 pt-8 border-t border-border/60 w-full">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground mt-0.5">M-Pesa STK Speed</div>
                </div>
                <div>
                ...
                <div className="space-y-3">
                  <div className="rounded-2xl bg-background/50 border border-border/60 p-4 space-y-2">
                    <div className="flex justify-between text-xs text-muted-foreground font-medium">
                      <span>Live M-Pesa STK Push Event</span>
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="grid gap-8 md:grid-cols-4">
              {[
                ...
                ["Define Packages", "Set speed limits, durations, and KES pricing."],
                ["Automated M-Pesa", "Subscribers pay via STK and get online instantly."],
              ].map(([title, body], i) => (
                <div
                  key={title}
      ...
      <footer className="border-t border-border/60 py-10 bg-background/50 relative z-20">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 text-sm text-muted-foreground sm:flex-row">
          <div className="flex items-center gap-2">
            ...
            <p>© {new Date().getFullYear()} Wifi Billing. Wi-Fi & PPPoE Billing for Kenyan ISPs.</p>
          </div>
