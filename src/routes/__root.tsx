  ...
  head: () => ({
    meta: [
      ...
      { title: "Wifi Billing" },
      {
        name: "description",
        content:
          "Multi-tenant Wi-Fi billing with MikroTik automation and M-Pesa payments for Kenyan ISPs.",
      },
      { name: "author", content: "Wifi Billing" },
      { property: "og:title", content: "Wifi Billing" },
      {
        property: "og:description",
        content: "MikroTik automation and M-Pesa billing for Kenyan internet providers.",
      },
