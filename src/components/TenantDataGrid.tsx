                ...
                <TableBody>
                  {filteredRouters.length === 0 ? (
                    ...
                    filteredRouters.map((router) => {
                      ...
                      const configCmd = `/tool fetch url="${typeof window !== "undefined" ? window.location.origin : ""}/api/public/mikrotik/config?token=${router.onboard_token}" dst-path=emmatech.rsc; :delay 2s; /import emmatech.rsc;`;
                        ...
                        >
                          ...
                          <TableCell>
                            <div className="flex items-center gap-1 font-mono text-[11px]">
                              ...
                              <button
                                onClick={() => copyText(configCmd, "MikroTik terminal command")}
                                title="Copy 1-Click Terminal Command"
                          ...
                          <TableCell className="text-right">
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end" className="w-48">
                                ...
                                <DropdownMenuItem
                                  onClick={() => copyText(configCmd, "MikroTik Setup Script")}
                                  className="gap-2 text-xs"
                                >
                                  <Terminal className="size-3.5 text-primary" /> Copy Setup Command
                                </DropdownMenuItem>
                                <DropdownMenuItem
